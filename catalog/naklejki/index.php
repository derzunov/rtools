<?
    ...
    // TODO: Прописывать пустоту в переменные $PageH1 и $PageDescription, если ?f= пуст (Так мы решили отделять ситуации,
    // когда человек просто пришел в корень каталога наклеек и когда он уже возвращается из фильтра или карточки) для того чтобы красная полоса не отображалась
    // если мы вернулись из карточки товара или из "Сбросиить фильтры"
