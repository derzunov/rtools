 - Прайсы
   - *Ссылка на страницу изменений цен на странице отображения прайса из исходной цены (в новой вкладке)
   - Показывать порог при демонстрации прайса
   - Показывать служебный комментарий в списке прайсов в усеченном варианте с ...
   - Сохранить / Утвердить
   ...
   * Поставить freemind
   * Корзина
   * Иконка копирования для имени файла в списке прайсов при ховере на него ( на имя файла )
 ...
 - IPM
   ...
   - Удаление только с предупреждением
